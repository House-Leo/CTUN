...
def create_lmdb_for_reds():
    ...
    """
    # train_sharp
    # folder_path = '/data1/lihao/datasets/VSR/REDS/trainwval_sharp'
    # lmdb_path = '/data1/lihao/datasets/VSR/REDS/train_sharp_with_val.lmdb'
    ...
    # train_sharp_bicubic
    folder_path = '/data1/lihao/datasets/VSR/REDS/trainwval_sharp_bicubic/X4'
    lmdb_path = '/data1/lihao/datasets/VSR/REDS/train_sharp_bicubic_with_val.lmdb'
    img_path_list, keys = prepare_keys_reds(folder_path)
    make_lmdb_from_imgs(folder_path, lmdb_path, img_path_list, keys, multiprocessing_read=True)
...
def create_lmdb_for_vimeo90k():
    ...
    """
    # GT
    folder_path = '/data1/lihao/datasets/VSR/vimeo90k/vimeo_septuplet/sequences'
    # lmdb_path = '/data1/lihao/VSR/vimeo90k/vimeo90k_train_GT_only4th.lmdb'
    train_list_path = '/data1/lihao/datasets/VSR/vimeo90k/vimeo_septuplet/sep_trainlist.txt' # VFI
    # img_path_list, keys = prepare_keys_vimeo90k(folder_path, train_list_path, 'gt') # VFI
    lmdb_path = '/data1/lihao/datasets/VSR/vimeo90k/vimeo90k_train_GT7frames.lmdb'
    img_path_list, keys = prepare_keys_vimeo90k(folder_path, train_list_path, 'gt')
    make_lmdb_from_imgs(folder_path, lmdb_path, img_path_list, keys, multiprocessing_read=True)

    # LQ
    folder_path = '/data1/lihao/datasets/VSR/vimeo90k/vimeo_septuplet_BDLRx4/sequences'
    lmdb_path = '/data1/lihao/datasets/VSR/vimeo90k/vimeo90k_train_BD7frames.lmdb'
    train_list_path = '/data1/lihao/datasets/VSR/vimeo90k/vimeo_septuplet/sep_trainlist.txt'
