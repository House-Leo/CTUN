...
if __name__ == '__main__':
    ...
    parser.add_argument('--gt', type=str, default='/data2/MillionIRData/Test_Public/4KRD/GT', help='Path to gt (Ground-Truth)')
    parser.add_argument('--restored', type=str, default='/data1/lihao/projects/AutoDIR/results-Public/4KRD', help='Path to restored images')
